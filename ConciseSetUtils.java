...
//改开始,add some constant value
   ...
   */
  public final static int MAX_FILL_NUM = 0x03ffffff;
  ...
  /**
   * Maximum number of the fills compressed in the L-F
   */
  public final static int MAX_L_F_NUM = 0x000000ff;
  /**
   * Maximum number of the fills compressed in the NI2L-F
   */
  public final static int MAX_NI2L_F_NUM = 0x0000007f;
  /**
  ...
  */
   ...
   */
  public final static int SEQUENCE_1_FILL = 0x04000000;
  /**
  ...
  /**
   * The header of the sequence L-F
   */
  public final static int SEQUENCE_L_F = 0x08000000;
  /**
   * The header of the sequence NI2L-F2
   */
  public final static int SEQUENCE_NI2L_F = 0x10000000;
...
//改开始
  ...
  {
	  return (word & 0xfc000000) == SEQUENCE_0_FILL;
  }
  /**
  ...
  {
	  return (word & 0xfc000000) == SEQUENCE_1_FILL;
  }
  /**
  ...
  public static boolean isDirtyByte0WordBy2(int word)
  {
	  int num = 0;
	  if(!(isLiteral(word)))
		  return false;
  ...
  public static int[] getDirtyByte0PosBy2(int word)
  {
	  int i;
	  int []pos = new int[2];
	  int t=0;
  ...
  public static boolean isDirtyByte1WordBy2(int word)
  {
	  int num = 0;
	  if(!(isLiteral(word)))
	  {
  ...
  public static int[] getDirtyByte1PosBy2(int word)
  {
	  int i;
	  int []pos = new int[2];
	  int t=0;
  ...
  /**
   * Checks whether a word is L-F
   *
   * @param word word to check
   *
   * @return <code>true</code> if the given word is a sequence of 0's
   */
  public static boolean isL_F(int word)
  {
    // "word" must be 00*
    return (word & 0xf8000000) == SEQUENCE_L_F;
  }
  /**
   * Checks whether a word is NI2L-F
   *
   * @param word word to check
   *
   * @return <code>true</code> if the given word is a sequence of 0's
   */
  public static boolean isNI2L_F(int word)
  {
    // "word" must be 00*
    return (word & 0xf0000000) == SEQUENCE_NI2L_F;
  }
  ...
  public static int[] getDirty0By2(int word)
  {
	  int []pos = new int[2];
	  int []Byte = new int[2];
	  int t=0;
	  if(isDirtyByte0WordBy2(word))
	  {
		  ...
		  for( t = 0; t<2; t++)
		  {
			  switch(pos[t])
			  {
		  case 0: Byte[t] = word & 0x000000ff;break;
		  case 1: Byte[t] = (word & 0x0000ff00) >>> 8;break;
		  case 2: Byte[t] = (word & 0x00ff0000) >>> 16; break;
  ...
  public static int[] getDirty1By2(int word)
  {
	  int []pos = new int[2];
	  int []Byte = new int[2];
	  int t=0;
	  if(isDirtyByte0WordBy2(word))
	  {
		  ...
		  for( t = 0; t<2; t++)
		  {
			  switch(pos[t])
			  {
				  case 0: Byte[t] = (~word & 0x000000ff) ^ 0x000000ff;break;
				  case 1: Byte[t] = ((~word & 0x0000ff00) >>> 8) ^ 0x00000ff;break;
				  case 2: Byte[t] = ((~word & 0x00ff0000) >>> 16) ^ 0x000000ff; break;
  ...
  /**
   *  When meeting the L-F,the number of the Fill words is useful
   *  This method is used for getting the number of the Fill words in the Fill compressed in the L-F word.
   */
  public static int getLFFILLWords(int word)
  {
	  int num;
	  if(isL_F(word))
	  {
  ...
  /**
   *  When meeting the NI2L-F,the number of the Fill words is useful
   *  This method is used for getting the number of the Fill words in the Fill compressed in the L-F-L word.
   */
  public static int getNI2LFFILLWords(int word)
  {
	  int num;
	  if(isNI2L_F(word))
	  {
  ...
  /**
   *  Return the Dirtybyte of the L-F.
   */
  public static int getLFLiteralWords(int word)
  {
	  int num;
	  if(isL_F(word))
	  {
   ...
   *  Return the Dirtybyte of the L-F.
   */
  public static int[] getNI2LFLiteralWords(int word)
  {
	  int[] num = new int[2];
	  if(isNI2L_F(word))
	  {
		  num[0] = (word & 0x0000ff00) >>> 8;
		  num[1] = (word & 0x00ff0000) >>> 16;
		  return num;
	  }
	  return null;
  }
  ...
  */
...

  {
    ...
    public void reset(int offset, int word, boolean fromBeginning)
    {
      ...
      offset += maxLiteralLengthMultiplication(fillnum[1]);
...

  {
    ...
    public void reset(int offset, int word, boolean fromBeginning)
    {
      ...
      offset += maxLiteralLengthMultiplication(fillnum);
      for(int j = 0 ;j<MAX_LITERAL_LENGTH ;j++)
      {
    	  if ((literal[1] & (1 << j)) != 0) 
              buffer[i++] = offset + j;
  ...
  public static LFExpander newLFExpander()
  {
    return new LFExpander();
  }
  
  public static class LFExpander implements WordExpander

  {
    ...
    public void reset(int offset, int word, boolean fromBeginning)
    {
      ...
      int literalType;
      int literalcount;
      int literalByte = getLFLiteralWords(word);
      fillnum = getLFFILLWords(word);
      fillType = (word & 0x02000000) >>> 25;
      literalPos = (word & 0x01800000) >>> 23;
      literalType = (word & 0x04000000) >>> 26;
      if(literalType == 0)
      {
      ...
      len += maxLiteralLengthMultiplication(fillnum * fillType);
      len += getLiteralBitCount(literal);
  ...
  public static NI2LFExpander newNI2LFExpander()
  {
    return new NI2LFExpander();
  }
  public static class NI2LFExpander implements WordExpander

  {
    ...
    public void reset(int offset, int word, boolean fromBeginning)
    {
      ...
      int[] literalPos = new int [2];
      int literalcount;
      int[] literalByte = getNI2LFLiteralWords(word);
      int pos = (word & 0x07000000) >>> 24;
      switch(pos)
      {
      ...
      fillnum = getNI2LFFILLWords(word);
      fillType = (word & 0x00000080) >>> 7;
